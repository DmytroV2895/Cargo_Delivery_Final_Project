...
public class Order {
    ...
    public boolean equals(Object o) {
        ...
        return orderId == order.orderId &&
                ...
                Double.compare(order.length, length) == 0 &&
                Double.compare(order.height, height) == 0 &&
                Double.compare(order.width, width) == 0 &&
                Double.compare(order.volume, volume) == 0 &&
                Double.compare(order.volumeWeight, volumeWeight) == 0 &&
                Objects.equals(orderName, order.orderName) &&
                type == order.type &&
                Objects.equals(orderDescription, order.orderDescription) &&
                Objects.equals(price, order.price) &&
                Objects.equals(userId, order.userId) &&
                Objects.equals(deliveryId, order.deliveryId);
    }

    @Override
    public int hashCode() {
        return Objects.hash(orderId, orderName, type, orderDescription, price, weight,
                length, height, width, volume, volumeWeight, userId, deliveryId);
    }
