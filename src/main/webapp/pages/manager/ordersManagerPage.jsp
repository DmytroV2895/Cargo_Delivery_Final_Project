                ...
                <div class="form-inline">
                    ...
                    <form action="controller" method="get">
                        ...
                        <c:forEach var="data" items="${invoice_list_manager}">
                            ...
                            <input type="hidden" name="type_of_report" value="${"ReportByDays"}">
                ...
                <div class="form-inline">
                    <form action="controller" method="get">
                        ...
                        <c:forEach var="data" items="${invoice_list_manager}">
                            ...
                            <input type="hidden" name="email" value="${data.user.email}">
                            <input type="hidden" name="locale" value="${locale}">
                            <input type="hidden" name="type_of_report" value="${"ReportByDestination"}">
        ...
        <table class="table">
            ...
            <tr>
                ...
                <th class="td-actions text-center" style="width: 150px"><b><fmt:message
                        key="label.delivery_date_manager_order_page"/></b>
                </th>
