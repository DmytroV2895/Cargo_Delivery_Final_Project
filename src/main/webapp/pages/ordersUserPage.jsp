    ...
    <div class="row">
        <div class="table-responsive" style="width: 1100px">
            <table class="table">
                <thead>
                <tr>
                    <th class="td-actions text-center"><b><fmt:message key="label.order_number_user_order_page"/></b>
                    </th>
                    <th class="td-actions text-center"><b><fmt:message key="label.order_name_user_order_page"/></b></th>
                    <th class="td-actions text-center"><b><fmt:message key="label.order_type_user_order_page"/></b></th>
                    <th class="td-actions text-center"><b><fmt:message
                            key="label.order_description_user_order_page"/></b></th>
                    <th class="td-actions text-center"><b><fmt:message key="label.order_volume_user_order_page"/></b>
                    </th>
                    <th class="td-actions text-center"><b><fmt:message key="label.order_weight_user_order_page"/></b>
                    </th>
                    ...
                    <th class="td-actions text-center"><b><fmt:message key="label.order_status_user_order_page"/></b>
                    </th>
                    <th class="td-actions text-center"><b><fmt:message key="label.actions_user_order_page"/></b></th>
                </tr>
                </thead>
                <tbody>
                <c:forEach var="data" items="${invoice_list}">
                    ...
                    <tr>
                        ...
                        <td class="td-actions text-center">
                            ...
                            <c:if test="${data.orderStatus eq 'ON_THE_WAY'}"><fmt:message key="label.order_on_the_way"/></c:if>
                        ...
                        <td class="td-actions text-right">
                            <c:if test="${data.orderStatus eq 'NOT_PROCESSED'}">
                                <form action="controller" method="get">
                                    <button
                                            class="btn btn-success btn-danger btn-sm" data-original-title="" title="">
