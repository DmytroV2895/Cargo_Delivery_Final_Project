...
public final class SQL_Queries {
    ...
    public static final String CHANGE_USER_PERSONAL_INFO = "UPDATE users SET name = ?, surname = ?, email = ?, password = ?, phone = ? WHERE user_id = ?";
    ...
    public static final String ADD_ORDER = "INSERT INTO orders (order_name , order_type, order_description, price, weight, length, height, width, volume, volume_weight, user_id, delivery_id) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    public static final String UPDATE_ORDER_DATA = "UPDATE orders SET order_name = ? , order_type = ?, order_description = ?, price = ?, weight = ?, length = ?, height = ?, width = ?, volume = ?, volume_weight = ?";
    ...
    public static final String UPDATE_DELIVERY_DATA = "UPDATE delivery set delivery_type = ?, distance = ?, recipient_name = ?, recipient_surname = ?, recipient_phone = ?";
    ...
    public static final String UPDATE_INVOICE_DATA = "UPDATE invoice set delivery_price = ?, total_price = ?";

    public static final String FIND_INVOICE_BY_RECIPIENT_PHONE = "SELECT\n" +
            ...
            "   users.id_user, users.name, users.surname, users.email, users.phone, \n" +
    ...
    public static final String FIND_ALL_INVOICE_DATA_BY_USER_ID = "SELECT\n" +
            "\tfirst_address.id_first_address, first_address.first_city, first_address.first_street_name, first_address.first_street_number, first_address.first_house_number,\n" +
            "\tsecond_address.id_second_address, second_address.second_city, second_address.second_street_name, second_address.second_street_number, second_address.second_house_number,\n" +
            "   delivery.id_delivery, delivery.delivery_type, delivery.distance, delivery.recipient_name, delivery.recipient_surname, delivery.recipient_phone, \n" +
    ...
    public static final String UPDATE_FIRST_ADDRESS = "UPDATE  first_address SET first_city = ?, first_street_name = ?, first_street_number = ?, first_house_number = ?";
    ...
    public static final String UPDATE_SECOND_ADDRESS = "UPDATE second_address SET second_city = ?, second_street_name = ?, second_street_number = ?, second_house_number = ?";
