...
/**
 * AddressFirst entity class. Matches table 'first_address' in database.
 *
...
public class AddressFirst  {
    ...
    public boolean equals(Object o) {
        ...
        return firstAddressId == that.firstAddressId &&
                firstCity.equals(that.firstCity) &&
                firstStreetName.equals(that.firstStreetName) &&
                firstStreetNumber.equals(that.firstStreetNumber) &&
                firstHouseNumber.equals(that.firstHouseNumber);
    }

    @Override
    public int hashCode() {
        return Objects.hash(firstAddressId, firstCity, firstStreetName,
                firstStreetNumber, firstHouseNumber);
    }
    ...
    public static class Builder {
        private final AddressFirst newAddressFirst;
