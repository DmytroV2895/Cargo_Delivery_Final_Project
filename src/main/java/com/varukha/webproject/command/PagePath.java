...
/**
 * Class PagePath contain all page paths and commands routs
 * that used in application commands.
 *
...
public final class PagePath {
	...
	public static final String LOG_IN_PAGE = "/pages/guest/logIn.jsp";
	...
	public static final String DELIVERY_PRICE_CALCULATION_PAGE = "/pages/guest/calculations.jsp";
	public static final String TO_DELIVERY_PRICE_CALCULATION_PAGE ="/controller?command=to_price_calculation_page";

	public static final String ERROR = "/pages/guest/error/error_404.jsp";

	public static final String TARIFFS_PAGE = "/pages/guest/tariffs.jsp";
	public static final String TO_TARIFFS_PAGE ="/controller?command=to_tariffs_page";
	public static final String DELIVERY_SERVICE_PAGE = "/pages/guest/deliveryService.jsp";
	public static final String TO_DELIVERY_SERVICE_PAGE ="/controller?command=to_delivery_service_page";

	public static final String ORDER_INFO_PAGE_GUEST = "/pages/guest/orderInfoPageGuest.jsp";
	public static final String TO_ORDER_INFO_PAGE_GUEST = "/controller?command=to_order_info_page_guest";
	public static final String NO_ACCESS_PAGE = "/pages/guest/noAccessPage.jsp";
	public static final String HEADER = "/pages/guest/header.jsp";
	...
	public static final String BILL_PAGE = "/pages/manager/bill.jsp";
	public static final String TO_BILL_PAGE ="/controller?command=to_bill_page";
	public static final String PERSONAL_PAGE_MANAGER = "/pages/manager/personalPageManager.jsp";
	public static final String ORDERS_MANAGER_PAGE = "/pages/manager/ordersManagerPage.jsp";
	public static final String TO_ORDERS_MANAGER_PAGE = "/controller?command=to_order_page_manager";
	public static final String ORDER_UPDATE_PAGE_MANAGER = "/pages/manager/orderUpdateDataManager.jsp";
	...
	public static final String PERSONAL_PAGE_USER = "/pages/user/personalPageUser.jsp";
	public static final String ORDER_UPDATE_PAGE_USER = "/pages/user/orderUpdateDataUser.jsp";
	public static final String TO_ORDER_UPDATE_PAGE_USER = "/controller?command=to_order_update_page";
	public static final String CREATE_ORDER_PAGE = "/pages/user/orderCreate.jsp";
	public static final String TO_CREATE_ORDER_PAGE = "/controller?command=to_create_order_page";
	public static final String ORDERS_USER_PAGE = "/pages/user/ordersUserPage.jsp";
	public static final String TO_ORDERS_USER_PAGE = "/controller?command=to_orders_page_user";
	public static final String DELIVERY_PAYMENT_PAGE = "/pages/user/userPaymentPage.jsp";
	public static final String TO_DELIVERY_PAYMENT_PAGE = "/controller?command=to_delivery_payment_page";
	public static final String SORTED_USER_ORDERS_BY_DELIVERY_CITY = "/pages/user/viewUserOrdersByDeliveryCity.jsp";
	...
	public static final String ORDER_INFO_PAGE = "/pages/user/orderInfoPage.jsp";
	public static final String TO_ORDER_INFO_PAGE = "/controller?command=to_order_info_page_user";

	// User and manager pages and commands routs
...
//	public static final String TO_MAIN_PAGE="/controller?command=to_main";
//	public static final String DELIVERY_PRICE_CALCULATION_PAGE = "/pages/calculations.jsp";
//	public static final String TO_DELIVERY_PRICE_CALCULATION_PAGE ="/controller?command=to_price_calculation_page";
//
