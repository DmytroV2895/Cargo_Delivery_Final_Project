...
/**
 * Invoice entity class. Matches table 'invoice' in database.
 *
...
public class Invoice {
    ...
    public boolean equals(Object o) {
        ...
        return invoiceId == invoice.invoiceId &&
                ...
                Objects.equals(deliveryDate, invoice.deliveryDate) &&
                Objects.equals(deliveryPrice, invoice.deliveryPrice) &&
                Objects.equals(totalPrice, invoice.totalPrice) &&
                Objects.equals(order, invoice.order) &&
                Objects.equals(user, invoice.user) &&
                Objects.equals(addressFirst, invoice.addressFirst) &&
                Objects.equals(addressSecond, invoice.addressSecond) &&
                Objects.equals(delivery, invoice.delivery) &&
                Objects.equals(creationDateTime, invoice.creationDateTime) &&
                orderStatus == invoice.orderStatus;
    }

    @Override
    public int hashCode() {
        return Objects.hash(invoiceId, deliveryDate, deliveryPrice, totalPrice,
                isDeliveryPaid, order, user, addressFirst, addressSecond, delivery, creationDateTime, orderStatus);
    }
