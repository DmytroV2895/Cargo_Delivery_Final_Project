    ...
    <div class="form">
        ...
        <div class="form-content bk">
            ...
            <form action="controller" method="post">
                            ...
                            <div class="form-group col-sm-4">
                                ...
                                <select class="form-control" id="first_city" name="first_city" required>
                                    <c:if test="${data.addressFirst.firstCity eq 'SUMY'}">
                                        <option value="SUMY"><fmt:message key="label.sumy"/></option></c:if>
                                    <c:if test="${data.addressFirst.firstCity eq 'LVIV'}">
                                        <option value="LVIV"><fmt:message key="label.lviv"/></option></c:if>
                                    <c:if test="${data.addressFirst.firstCity eq 'CHARKIV'}">
                                        <option value="CHARKIV"><fmt:message key="label.charkiv"/></option></c:if>
                                    <c:if test="${data.addressFirst.firstCity eq 'ODESSA'}">
                                        <option value="ODESSA"><fmt:message key="label.odessa"/></option></c:if>
                ...
                <input type="hidden" name="first_address_id" value="${data.addressFirst.firstAddressId}">
                <input type="hidden" name="second_address_id" value="${data.addressSecond.secondAddressId}">
